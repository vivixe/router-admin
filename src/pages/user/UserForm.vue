      ...
      <a-form-item label="姓名" has-feedback>
        <a-input
          v-decorator="[
            ...
            {
              rules: [
                { required: true, message: 'Please input the name of worker!' },
              ],
            },
          ]"
        />
      ...
      <a-form-item label="Position" has-feedback>
        <a-select
          v-decorator="[
            ...
            {
              rules: [
                { required: true, message: 'Please select work position!' },
              ],
            },
          ]"
        ...
        >
          ...
          <a-select-option value="UI Designer"> UI Designer </a-select-option>
          <a-select-option value="Test Engineer">
            Test Engineer
          </a-select-option>
          <a-select-option value="Data Analyst"> Data Analyst </a-select-option>
        </a-select>
      </a-form-item>
          ...
          v-decorator="[
            'address',
            {
              rules: [
                {
                  required: true,
                  message: 'Please input the address of worker!',
                },
              ],
            },
          ]"
...
<script>
import { saveWorkerAPI, getWorkerInfoAPI } from '@/api/worker/Worker'
export default {
  data() {
    return {
