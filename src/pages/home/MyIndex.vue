		...
		<div class="index-main">
			...
			<div class="index-main-title">
				<div class="index-main-title-left">
					...
					<span class="title-sub">欢迎来到万华软件后台管理系统，今日打卡32/65</span>
				</div>
				<div class="index-main-title-right">
					<a-date-picker placeholder="日" @change="onChange" :format="dateFormat" />
					<br />
					<a-week-picker placeholder="周" @change="onChange" :format="weekFormat" />
					<br />
					<a-month-picker placeholder="月" @change="onChange" :format="monthFormat" />
				</div>
			</div>
			<div class="index-main-table">
				<div class="index-main-table-tags">
					<div class="table-tags-body" v-for="item in filterSource" :key="item.id">
				...
				<div class="index-main-table-body1">
					...
					<div class="body1-smooth-chart">
						<e-charts class="smooth-chart-body" :option="smoothChartOptions" style="margin-left: 25px" />
					</div>
				</div>
				<div class="index-main-table-body2">
					<div class="body2-table">
						<template>
							<a-table :columns="columns" :data-source="dataSource" :pagination="{ pageSize: 2 }"
								:rowKey="(row) => row.id" style="padding: 0 20px">
                  ...
                  margin: '0 32px',
							...
							<a-statistic title="Trainees" prefix="+" :value="2" :style="{
                  margin: '0 32px',
                }" />
						</a-row>
						<a-row type="flex">
							<a-statistic title="ChangeInfo" value="Programs" />
							<a-statistic title="Finished" prefix="+" :value="2" :style="{
                  margin: '0 32px',
                }" />
							<a-statistic title="Developing" prefix="" :value="12" />
							<a-statistic title="Failed" prefix="+" :value="1" :style="{
                  margin: '0 32px',
                }" />
						</a-row>
					</div>
		...
		<div class="index-info">
			<div class="avatar-container" @click="toAboutMe">
				<a-tooltip placement="bottom">
					...
					<a-avatar shape="square" :size="56" :src="require('@/assets/headpic.jpg')" class="avatar-body" />
				</a-tooltip>
			...
			<div class="update-info">
				...
				<div class="info-article">
					...
					<div class="article-content">
						<span class="article-content-word">服务器将进行例行维护， 预计维护时间大约：1小时。
						</span>
					</div>
					<div class="article-time">
...
<script>
	import {
		lineChartOptions
	} from '@/data/lineChartOptions'
	import {
		pineOptions
	} from '@/data/pineOptions'
	import {
		smoothChartOptions
	} from '@/data/smoothChartOptions'
	import {
		getProgramListAPI
